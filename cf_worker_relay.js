...
快速操作`;
        ...
        const btns = [
            [{ text: "🏛️ 集群指挥中心", callback_data: "show_status" }, { text: "🚀 快速扩容", callback_data: "quick_deploy" }, { text: "🔄 升级指挥部", callback_data: "self_update_worker" }],
            [{ text: "🔑 集群令牌", callback_data: "show_cluster_token" }, { text: "🚑 救援日志", callback_data: "show_rescue" }, { text: "📊 数据统计", callback_data: "show_traffic_stats" }],
