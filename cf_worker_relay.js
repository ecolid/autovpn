...
━━━━━━━━━━━━━━━━━━━━━━`;
        ...
        const btns = [
            ...
            [{ text: "🔑 集群令牌", callback_data: "show_cluster_token" }, { text: "🔄 升级指挥部", callback_data: "self_update_worker" }, { text: "🚑 救援日志", callback_data: "show_rescue" }],
...
🔧 服务状态
  Xray:    ${h.xray === "OK" ? "🟢 正常" : "🔴 异常"}
  Nginx:   ${h.nginx === "OK" ? "🟢 正常" : "🔴 异常"}
  WARP:    ${(h.warp === "OFF" || h.warp === "SKIP") ? "⚪ 跳过" : (h.warp === "OK" ? "🟢 正常" : "🔴 异常")}
  Loop:    ${h.loop === "OK" ? "🟢 正常" : "🔴 异常"}
